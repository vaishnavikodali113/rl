...
### All Baseline Learning Curves

![PPO, SAC and TD-MPC2 Learning Curves](logs/all_results.png)

*Left: PPO on Walker-Walk · Centre: SAC on Cheetah-Run · Right: TD-MPC2 (MLP) on Walker-Walk*

> Note: TD-MPC2 with MLP dynamics converges slower than SAC on this task and operates in a much narrower reward band (38–47) compared to PPO (~20–184) and SAC (~0–530). This is expected — the MLP dynamics model requires more data to learn accurate latent transitions, and MPPI planning overhead limits exploration speed. The SSM variant (Step 3) is expected to improve this significantly.
...
- [GAE Paper — Schulman et al. 2015](https://arxiv.org/abs/1506.02438)| 2 | TD-MPC2 MLP baseline (world model + MPPI planner) | ✅ Done |
| 3 | SSM dynamics integration (Student C) | 🔲 Pending |
| 4 | Multi-seed experiments + final comparison plots | 🔲 Pending |
...
![PPO, SAC and TD-MPC2 Learning Curves](Figure_2.png)
